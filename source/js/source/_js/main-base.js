...
module.exports = {
  activate: function activate() {
    f.component_init('.max-c-wisdom', ma_wisdom);
  }
};

},{"../functions/basic":4,"jquery":2}],4:[function(require,module,exports){
'use strict';
...
module.exports = {
  component_init: function component_init(selector, component_function) {
  ...
  img_to_figures: function img_to_figures(selector) {
    $(selector).each(function () {
      ...
      if ($(this).closest('figure').length === 0) {
        ...
        $(this).wrap("<figure class='max-flex max-flex-column max-flex-align-start max-m-none max-my-oneHalf'></figure>");
